 ...
 *
 * @property toolbar Reference to the browser toolbar, so that the color and menu items can be set.
 * @property sessionId ID of the custom tab session. No-op if null or invalid.
 * @property menuBuilder Menu builder reference to pull menu options from.
 ...
 * @property updateToolbarBackground Whether or not the toolbar background should be changed based on
